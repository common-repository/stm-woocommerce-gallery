=== STM WooCommerce Gallery 1.9 ===
Contributors: sergiotoca
Donate link: http://sergiotoca.com/
Tags: product, products, woocommerce, image, images, gallery, galleries, collage, collages
...
This plugin allows you to create original compositions with the images of your WooCommerce shop products. Este plugin te permite crear originales composiciones con las imágenes de los productos de tu tienda WooCommerce.
...
1. Sample composition with colored blackground and normal images not rotated.
2. Sample composition with image blackground and larger images rotated.
3. The transition between compositions can be changing or continuing.
4. General screen compositions.
5. Page template for compositions.
